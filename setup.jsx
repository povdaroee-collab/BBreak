...
const IconCheckIn = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M7 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 003 3h1a3 3 0 003-3V7a3 3 0 00-3-3h-1a3 3 0 00-3 3v1"
    ></path>
  </svg>
);
const IconSearch = () => (
...
const IconQrCode = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M4 4h4v4H4zM4 16h4v4H4zM16 4h4v4h-4zM16 16h4v4h-4zM10 4h4v4h-4zM10 16h4v4h-4zM4 10h4v4H4zM16 10h4v4h-4zM10 10h4v4h-4z"
    ></path>
  </svg>
);
const IconPencil = () => (
...
const IconLanguage = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M3 5h12M9 3v2m4 13h4m-4 1v2m-3-14l-3 6h6m-3 6l6-6M9 21v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6h6z"
    ></path>
  </svg>
);
...
const IconToggleLeft = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v12a1 1 0 01-1 1h-3a1 1 0 00-1-1v-1a2 2 0 10-4 0v1a1 1 0 00-1 1H7a1 1 0 01-1-1V6a1 1 0 011-1h3a1 1 0 001-1V4z"
    ></path>
  </svg>
);
const IconToggleRight = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v12a1 1 0 01-1 1h-3a1 1 0 00-1-1v-1a2 2 0 10-4 0v1a1 1 0 00-1 1H7a1 1 0 01-1-1V6a1 1 0 011-1h3a1 1 0 001-1V4zM4.5 9.5l.01 0M4.5 14.5l.01 0M19.5 9.5l.01 0M19.5 14.5l.01 0"
    ></path>
  </svg>
);
...
const IconHash = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M7 20l4-16m2 16l4-16M5 9h14M5 15h14"
    ></path>
  </svg>
);
const IconType = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M9 12h6M9 12V6a2 2 0 114 0v6m-2 6v-3m-6-3h12a2 2 0 012 2v3a2 2 0 01-2 2H9a2 2 0 01-2-2v-3a2 2 0 012-2z"
    ></path>
  </svg>
);
const IconCameraRotate = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M16 10h4l-2-2m-2 2l2-2m-2 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2v-4m0 0l-2 2m2-2l-2 2m2-2H8m8 6h2a2 2 0 002-2v-4a2 2 0 00-2-2h-4a2 2 0 00-2 2v4a2 2 0 002 2h2m-4-4a2 2 0 100-4 2 2 0 000 4z"
    ></path>
  </svg>
);
...
const translations = {
  km: {
    ...
    deleteConfirmMessage: (name) =>
      `តើអ្នកប្រាកដទេថាចង់លុបទិន្នន័យរបស់ ${name}?`,
    ...
    // !! ថ្មី !!: Auto Check-out Translations
    autoCheckOutTitle: "កត់ត្រាចេញស្វ័យប្រវត្តិ",
    autoCheckOutOn: "បើក (ON)",
    autoCheckOutOff: "បិទ (OFF)",
    autoCheckOutPrompt:
      "បញ្ជាក់៖ តើអ្នកចង់ប្តូរមុខងារកត់ត្រាចេញស្វ័យប្រវត្តិមែនទេ?",
    autoCheckOutSuccess: "បានប្តូរមុខងារកត់ត្រាចេញស្វ័យប្រវត្តិ!",
  },
  en: {
    ...
    autoCheckOutOn: "Enabled (ON)",
    autoCheckOutOff: "Disabled (OFF)",
    autoCheckOutPrompt: "Confirm to toggle Auto Check-out?",
    autoCheckOutSuccess: "Auto Check-out setting updated!",
  },
};

// !! ថ្មី !!: កំណត់ APP BRANCH ដោយផ្អែកលើ APP TITLE
const appTitleKm = translations.km.appTitle || "";
let appBranch = "default";
if (appTitleKm.startsWith("A-")) {
  appBranch = "A";
